...
(function($) {
    ...
    **/
    var launch = new Date(2015, 11, 10, 11, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('Estamos haciendo lo mejor para mostrarte nuestro trabajo...');
        }
        else{
            ...
            message.html('Estamos preparandonos para mostrate más sobre nuestra fundación');
        }
    }
})(jQuery);
/******************************************************************************************************************************
